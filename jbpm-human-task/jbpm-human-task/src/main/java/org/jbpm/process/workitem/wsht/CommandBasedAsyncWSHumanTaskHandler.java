...
public class CommandBasedAsyncWSHumanTaskHandler implements WorkItemHandler {
	...
	public CommandBasedAsyncWSHumanTaskHandler(KnowledgeRuntime session) {
	...
	public void connect() {
                if( client == null){
                    throw new IllegalStateException("You must set a client first!");
                }
		if (client != null) {
