...
public class TaskQueryBuilderCoverageTest extends HumanTaskServicesBaseTest {
    ...
    public void devTest() { 
       ...
       Join potOwnerJoin = peopleAssignJoin.join(PeopleAssignmentsImpl_.potentialOwners);
        
       Expression field = potOwnerJoin.get(UserImpl_.id);
       query.where(builder.equal(field, "userId"));
