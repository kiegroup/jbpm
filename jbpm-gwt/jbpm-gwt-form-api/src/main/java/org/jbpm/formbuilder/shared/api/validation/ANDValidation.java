...
@Reflectable
public class ANDValidation implements FBValidation {
    ...
    public Map<String, Object> getDataMap() {
        if (!propertiesMap.containsKey("@className") || !ANDValidation.class.getName().equals(propertiesMap.get("@className"))) {
            propertiesMap.put("@className", ANDValidation.class.getName());
        }
    ...
    public FBValidation cloneValidation() {
        ANDValidation validation = new ANDValidation();
