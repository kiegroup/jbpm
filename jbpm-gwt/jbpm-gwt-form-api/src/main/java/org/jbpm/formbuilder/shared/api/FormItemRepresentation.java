...
public abstract class FormItemRepresentation implements Mappable {
    ...
    public void setDataMap(Map<String, Object> data) throws FormEncodingException {
        ...
        this.external = (ExternalData) decoder.decode((Map<String, Object>) data.get("external"));
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((effectClasses == null) ? 0 : effectClasses.hashCode());
        ...
        result = prime * result + ((itemClassName == null) ? 0 : itemClassName.hashCode());
        result = prime * result + ((itemValidations == null) ? 0 : itemValidations.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (effectClasses == null) {
            if (other.effectClasses != null) return false;
        } else if (!effectClasses.equals(other.effectClasses)) return false;
        if (eventActions == null) {
            if (other.eventActions != null) return false;
        } else if (!eventActions.equals(other.eventActions)) return false;
        if (external == null) {
        ...
        if (itemClassName == null) {
            if (other.itemClassName != null) return false;
        } else if (!itemClassName.equals(other.itemClassName)) return false;
        if (itemValidations == null) {
            if (other.itemValidations != null) return false;
        } else if (!itemValidations.equals(other.itemValidations)) return false;
        if (output == null) {
