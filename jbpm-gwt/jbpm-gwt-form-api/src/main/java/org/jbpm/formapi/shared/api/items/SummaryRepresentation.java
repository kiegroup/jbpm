...
public class SummaryRepresentation extends FormItemRepresentation {
	...
	public boolean equals(Object obj) {
		...
		if (i18n == null) {
			if (other.i18n != null) return false;
		} else if (!i18n.equals(other.i18n)) return false;
		if (items == null) {
		...
		if (scrollLeft != other.scrollLeft) return false;
		if (scrollTop != other.scrollTop) return false;
		return true;
	}
