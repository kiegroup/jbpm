...
public class FormEncodingClientFactoryGwtTest extends GWTTestCase {
    ...
    private static final String JSON = "{\"name\": \"myForm\",\"action\": \"complete\","+
        ...
        "\"itemValidations\": [],\"columns\": 2,\"@className\": \"org.jbpm.formbuilder.shared.rep.items.TableRepresentation\","+
        ...
        "\"org.jbpm.formbuilder.shared.rep.items.LabelRepresentation\",\"width\": null,\"height\": null,\"output\": null,\"cssName\": null,"+
        "\"itemValidations\": [],\"id\": null},{\"maxLength\": null,\"typeId\": \"textField\",\"input\": null,\"@className\": " +
        "\"org.jbpm.formbuilder.shared.rep.items.TextFieldRepresentation\",\"width\": \"160px\",\"defaultValue\": null,\"height\": \"21px\"," +
        "\"output\": null,\"itemValidations\": [],\"name\": \"usr\",\"id\": null}],[{\"value\": null,\"typeId\": \"label\",\"input\": null,"+
        "\"@className\": \"org.jbpm.formbuilder.shared.rep.items.LabelRepresentation\",\"width\": null,\"height\": null,"+
        ...
        "\"@className\": \"org.jbpm.formbuilder.shared.rep.OutputData\",\"mimeType\": null,\"value\": \"${pwd}\"," +
