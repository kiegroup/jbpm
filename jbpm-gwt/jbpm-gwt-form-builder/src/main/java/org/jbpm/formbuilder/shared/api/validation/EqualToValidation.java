...
@Reflectable
public class EqualToValidation implements FBValidation {
    ...
    public Map<String, Object> getDataMap() {
        if (!propertiesMap.containsKey("@className") ||
                !EqualToValidation.class.getName().equals(propertiesMap.get("@className"))) {
            propertiesMap.put("@className", EqualToValidation.class.getName());
        }
