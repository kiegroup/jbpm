...
public class AbsoluteLayoutMenuItem extends FBMenuItem {
    ...
    public Label getDescription() {
        return new Label(FormBuilderGlobals.getInstance().getI18n().MenuItemAbsoluteLayout());
    }

    @Override
    public FBMenuItem cloneWidget() {
        return clone(new AbsoluteLayoutMenuItem());
    }

    @Override
    public FBFormItem buildWidget() {
        return build(new AbsoluteLayoutFormItem());
    }
