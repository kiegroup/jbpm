...
public class MapDBSignalManager extends DefaultSignalManager {
    private static final String ASYNC_SIGNAL_PREFIX = "ASYNC-";
    private static final Logger logger = LoggerFactory.getLogger(MapDBSignalManager.class);
	
	public MapDBSignalManager(InternalKnowledgeRuntime kruntime) {
		super(kruntime);
	}
