...
public abstract class NodeInstanceImpl implements org.jbpm.workflow.instance.NodeInstance, Serializable {
    ...
    /**
     * This method is overridden by implementation classes for use with stackless
     */
    ...
    protected void triggerCompleted(String type, boolean remove) {
        ...
        if (node != null) {
            if ("true".equals(System.getProperty("jbpm.enable.multi.con")) && ((NodeImpl) node).getConstraints().size() > 0) {
                ...
                boolean found = false;
                List<NodeInstanceTriggerAction> nodeInstances = new ArrayList<NodeInstanceTriggerAction>();
                ...
                for (NodeInstanceTriggerAction nodeInstance: nodeInstances) {
