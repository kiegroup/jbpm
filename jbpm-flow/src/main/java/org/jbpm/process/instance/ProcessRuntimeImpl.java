...
public class ProcessRuntimeImpl implements InternalProcessRuntime {
    ...
    private class StartProcessEventListener implements EventListener, ProcessImplementationPart {
	    ...
	    public boolean isStackless() {
	        return RuleFlowProcessInstanceFactory.useStacklessExecution(kruntime.getEnvironment());
	    }
	}
