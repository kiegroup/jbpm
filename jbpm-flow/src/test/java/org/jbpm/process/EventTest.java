...
public class EventTest extends AbstractBaseTest  {
    ...
    public EventTest(String execModel) {
        this.queueBasedExecution = QUEUE_BASED_EXECUTION.equals(execModel);
    }

    @Before
    public void og() {
        System.out.println("> " + ( queueBasedExecution ? "queueBased" : "RECURSIVE" ) + ": " + testName.getMethodName());
    }

    final static String [] test1EventOrder = {
            "bps",
            "bnt-1", "bnl-1",
            "bnt-2", "ant-2",
            "anl-1", "ant-1",
    ...
    final static String [] test2EventOrder = {
            "bps",
            "bnt-1", "bnl-1",
            "bnt-2", "ant-2",
            "anl-1", "ant-1",
    ...
    final static String [] test3EventOrder = {
            "bps",
            "bnt-1", "bnl-1",
            "bnt-7", "ant-7",
            "anl-1", "ant-1",
    ...
    final static String [] test3aEventOrder = {
            "bps",
            "bnt-1", "bnl-1",
            "bnt-7", "ant-7",
            "anl-1", "ant-1",
    ...
    final static String [] test4EventOrder = {
            "bps",
            "bnt-1", "bnl-1",
            "bnt-7", "ant-7",
            "anl-1", "ant-1",
