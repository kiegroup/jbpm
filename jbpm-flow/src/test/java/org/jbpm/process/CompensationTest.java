...
public class CompensationTest extends AbstractBaseTest {
    ...
    public CompensationTest(String execModel) {
    ...
    private TestFlowProcessEventListener procEventListener = new TestFlowProcessEventListener();
    ...
    public void cleanUp() {
        ...
        procEventListener = new TestFlowProcessEventListener();
    }
