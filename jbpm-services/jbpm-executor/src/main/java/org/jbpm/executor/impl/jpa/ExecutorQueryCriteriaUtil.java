...
public class ExecutorQueryCriteriaUtil extends QueryCriteriaUtil {
    ...
    @Override
    protected <R, T> Predicate implSpecificCreatePredicateFromSingleCriteria( CriteriaQuery<R> criteriaQuery,
            QueryCriteria criteria, CriteriaBuilder criteriaBuilder, Root<?> table, Class<T> resultType ) {
