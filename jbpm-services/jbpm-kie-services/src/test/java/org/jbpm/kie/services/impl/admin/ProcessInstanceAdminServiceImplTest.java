...
public class ProcessInstanceAdminServiceImplTest extends AbstractKieServicesBaseTest {
    ...
    @Test
    public void testGetNodesWithDeploymentId() {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "org.jbpm.writedocument");
        assertNotNull(processInstanceId);
        
        Collection<ProcessNode> processNodes = processAdminService.getProcessNodes(deploymentUnit.getIdentifier(), processInstanceId);
        assertNotNull(processNodes);
        assertEquals(8, processNodes.size());
    ...
    @Test(expected = IncorrectDeploymentIDException.class)
    public void testGetNodesWithIncorrectDeploymentId() {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "org.jbpm.writedocument");
        assertNotNull(processInstanceId);
        
		Collection<ProcessNode> processNodes = processAdminService.getProcessNodes("IncorrectDeploymentID",	processInstanceId);	
    }
    
    @Test(expected = ProcessInstanceNotFoundException.class)
    public void testGetActiveNodesWithIncorrectProcessInstanceId() {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "org.jbpm.writedocument");
        assertNotNull(processInstanceId);

        Collection<NodeInstanceDesc> activeNodes = processAdminService.getActiveNodeInstances(deploymentUnit.getIdentifier(), new Random().nextLong());
    }

    @Test(expected = IncorrectDeploymentIDException.class)
    public void testGetActiveNodesWithIncorrectDeploymentId() {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "org.jbpm.writedocument");
        assertNotNull(processInstanceId);

        Collection<NodeInstanceDesc> activeNodes = processAdminService.getActiveNodeInstances("IncorrectDeploymentID", processInstanceId);
    }
    ...
    @Test
    public void testCancelAndTriggerWithDeploymentId() {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "org.jbpm.writedocument");
        assertNotNull(processInstanceId);
        
        Collection<NodeInstanceDesc> activeNodes = processAdminService.getActiveNodeInstances(deploymentUnit.getIdentifier(), processInstanceId);
        assertNotNull(activeNodes);
        assertEquals(1, activeNodes.size());
        ...
        processAdminService.cancelNodeInstance(deploymentUnit.getIdentifier(), processInstanceId, active.getId());
        
        activeNodes = processAdminService.getActiveNodeInstances(deploymentUnit.getIdentifier(), processInstanceId);
        assertNotNull(activeNodes);
        assertEquals(0, activeNodes.size());
        tasks = runtimeDataService.getTasksAssignedAsPotentialOwner("salaboy", new QueryFilter());
        assertEquals(0, tasks.size());
        ...
        processAdminService.triggerNode(deploymentUnit.getIdentifier(), processInstanceId, writeDocNode.getNodeId());
        activeNodes = processAdminService.getActiveNodeInstances(deploymentUnit.getIdentifier(), processInstanceId);
        assertNotNull(activeNodes);
        assertEquals(1, activeNodes.size());
    ...
    @Test
    public void testTriggerSubProcessNodeInstance_WithDeploymentId() {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "AdHocSubProcess");
        assertNotNull(processInstanceId);
        ...
        processAdminService.triggerNode(deploymentUnit.getIdentifier(), processInstanceId, taskNode.getNodeId());
    ...
    @Test
    public void testReTriggerNodeInstanceWithDeploymentId() {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "org.jbpm.writedocument");
        assertNotNull(processInstanceId);
        ...
        // aborts the current node
        processAdminService.retriggerNodeInstance(deploymentUnit.getIdentifier(), processInstanceId, active.getId());
    ...
    @Test
    public void testCancelAndTriggerAnotherNodeWithDeploymentId() {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "org.jbpm.writedocument");
        assertNotNull(processInstanceId);
    ...
    @Test
    public void testTriggerLastActionNodeWithDeploymentId() {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "org.jbpm.writedocument");
        assertNotNull(processInstanceId);
    ...
    @Test(timeout=10000)
    public void testUpdateTimerWithDeployment() throws Exception {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "IntermediateCatchEvent");
        assertNotNull(processInstanceId);
        long scheduleTime = System.currentTimeMillis();
        ...
        Collection<TimerInstance> timers = processAdminService.getTimerInstances(deploymentUnit.getIdentifier(), processInstanceId);
        assertNotNull(timers);
        assertEquals(1, timers.size());
        ...
        processAdminService.updateTimer(deploymentUnit.getIdentifier(), processInstanceId, timer.getId(), 3, 0, 0);
    ...
    @Test(timeout=10000)
    public void testListSLATimerWithDeploymentId() throws Exception {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "UserTaskWithSLAOnTask");
        assertNotNull(processInstanceId);
    ...
    @Test(timeout=10000)
    public void testUpdateTimerRelativeWithDeploymentId() throws Exception {
        processInstanceId = processService.startProcess(deploymentUnit.getIdentifier(), "IntermediateCatchEvent");
        assertNotNull(processInstanceId);
        long scheduleTime = System.currentTimeMillis();
        ...
        processAdminService.updateTimerRelative(deploymentUnit.getIdentifier(), processInstanceId, timer.getId(), 3, 0, 0);
