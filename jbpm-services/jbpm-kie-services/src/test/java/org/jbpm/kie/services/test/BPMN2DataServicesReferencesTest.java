...
public class BPMN2DataServicesReferencesTest extends AbstractKieServicesBaseTest {
    ...
    private boolean loadJavaMvelScriptProcesses = false;
    ...
    public void prepare() {
        ...
        if( loadJavaMvelScriptProcesses ) { 
            ...
            resources.add("repo/processes/references/ruleScriptTaskWithQualifiedClass.bpmn2");
        }
    ...
    @Test
    public void testScriptWithQualifiedClass() throws IOException {
        Assume.assumeTrue("Skip script/expr tests", loadJavaMvelScriptProcesses);
        String processId = PROC_ID_JAVA_SCRIPT_QUALIFIED_CLASS;
