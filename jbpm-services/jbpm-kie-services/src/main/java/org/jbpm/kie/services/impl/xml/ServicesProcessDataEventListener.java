...
public class ServicesProcessDataEventListener implements ProcessDataEventListener {
    ...
    public void onMetaDataAdded(String name, Object data) {
        if (name.equals("Variable")) {
            String structureRef = processDescriptor.getGlobalItemDefinitions().get(((Variable)data).getMetaData("ItemSubjectRef"));
            if(structureRef != null) {
                processDescriptor.getInputs().put(((Variable)data).getName(), structureRef);
            } else { 
                processDescriptor.getInputs().put(((Variable)data).getName(), ((Variable)data).getType().getStringType());
            }
