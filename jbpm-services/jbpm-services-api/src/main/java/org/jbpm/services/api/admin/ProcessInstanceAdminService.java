...
public interface ProcessInstanceAdminService {
     ...
     * @return list of process nodes in process instance
     * @throws ProcessInstanceNotFoundException in case process instance id with given id was not found
     * @throws IncorrectDeploymentIDException in case provided process instance id does not belong to provided deploymentId 
     */
    Collection<ProcessNode> getProcessNodes(String deploymentId, long processInstanceId) throws ProcessInstanceNotFoundException, IncorrectDeploymentIDException;
     ...
     * @throws IncorrectDeploymentIDException in case provided process instance id does not belong to provided deploymentId 
     */
    void cancelNodeInstance(String deploymentId, long processInstanceId, long nodeInstanceId) throws NodeInstanceNotFoundException, ProcessInstanceNotFoundException, IncorrectDeploymentIDException;
     ...
     * @throws IncorrectDeploymentIDException in case provided process instance id does not belong to provided deploymentId 
     */
    void retriggerNodeInstance(String deploymentId, long processInstanceId, long nodeInstanceId) throws NodeInstanceNotFoundException, ProcessInstanceNotFoundException, IncorrectDeploymentIDException;
     ...
     * @throws IncorrectDeploymentIDException in case provided process instance id does not belong to provided deploymentId 
     */
    Collection<NodeInstanceDesc> getActiveNodeInstances(String deploymentId, long processInstanceId) throws ProcessInstanceNotFoundException, IncorrectDeploymentIDException;
     ...
     * @throws IncorrectDeploymentIDException in case provided process instance id does not belong to provided deploymentId 
     */
    void updateTimer(String deploymentId, long processInstanceId, long timerId, long delay, long period, int repeatLimit) throws NodeInstanceNotFoundException, ProcessInstanceNotFoundException, IncorrectDeploymentIDException;
     ...
     * @throws IncorrectDeploymentIDException in case provided process instance id does not belong to provided deploymentId 
     */
    void updateTimerRelative(String deploymentId, long processInstanceId, long timerId, long delay, long period, int repeatLimit) throws NodeInstanceNotFoundException, ProcessInstanceNotFoundException, IncorrectDeploymentIDException;
     ...
     * @throws IncorrectDeploymentIDException in case provided process instance id does not belong to provided deploymentId 
     */
    Collection<TimerInstance> getTimerInstances(String deploymentId, long processInstanceId) throws ProcessInstanceNotFoundException, IncorrectDeploymentIDException;
     ...
     * @throws IncorrectDeploymentIDException in case provided process instance id does not belong to provided deploymentId 
     */
    void triggerNode(String deploymentId, long processInstanceId, long nodeId) throws NodeNotFoundException, ProcessInstanceNotFoundException, IncorrectDeploymentIDException;
     ...
     * @throws ProcessInstanceNotFoundException in case process instance id with given id was not found
     */
    List<ExecutionError> getErrorsByProcessInstanceId(long processInstanceId, boolean includeAcknowledged, QueryContext queryContext) throws ProcessInstanceNotFoundException;
     ...
     * @throws IncorrectDeploymentIDException in case provided process instance id does not belong to provided deploymentId 
     */
    List<ExecutionError> getErrorsByProcessInstanceId(String deploymentId, long processInstanceId, boolean includeAcknowledged, QueryContext queryContext) throws ProcessInstanceNotFoundException, IncorrectDeploymentIDException;
     ...
     * @throws ProcessInstanceNotFoundException in case process instance id with given id was not found
     */
    List<ExecutionError> getErrorsByProcessInstanceId(long processInstanceId, String nodeName, boolean includeAcknowledged, QueryContext queryContext)  throws ProcessInstanceNotFoundException;
     ...
     * @throws IncorrectDeploymentIDException in case provided process instance id does not belong to provided deploymentId
     */
    List<ExecutionError> getErrorsByProcessInstanceId(String deploymentId, long processInstanceId, String nodeName, boolean includeAcknowledged, QueryContext queryContext) throws ProcessInstanceNotFoundException, NodeNotFoundException, IncorrectDeploymentIDException;;
