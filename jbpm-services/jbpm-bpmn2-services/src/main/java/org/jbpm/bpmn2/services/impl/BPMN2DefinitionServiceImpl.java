 ...
 */
package org.jbpm.bpmn2.services.impl;
 ...
 *
 */
public class BPMN2DefinitionServiceImpl implements DefinitionService {

    private static final Logger logger = LoggerFactory.getLogger(BPMN2DefinitionServiceImpl.class);

    protected ConcurrentMap<String, Map<String, ProcessDescriptor>> definitionCache = new ConcurrentHashMap<String, Map<String, ProcessDescriptor>>();
    ...
    protected ProcessAssetDesc fillProcessDefinition(ProcessDescriptor helper, KieContainer kieContainer ) {
    ...
    protected void validateNonEmptyDeploymentIdAndProcessId(String deploymentId, String processId) {
        validateNonEmptyDeploymentIdAndProcessIdAndTaskName(deploymentId, processId, "x");
     }

    protected void validateNonEmptyDeploymentIdAndProcessIdAndTaskName(String deploymentId, String processId, String taskName) {
