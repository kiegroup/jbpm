...
public class DataOutputAssociationReader implements ElementReader<DataAssociation>{

    private static final Logger logger = LoggerFactory.getLogger(DataOutputAssociationReader.class);

    private AssignmentReader assignmentReader;
    
    
    public DataOutputAssociationReader() {
