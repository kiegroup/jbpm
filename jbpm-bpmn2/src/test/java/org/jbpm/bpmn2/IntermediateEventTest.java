...
public class IntermediateEventTest extends JbpmBpmn2TestCase {
    ...
    public IntermediateEventTest(boolean persistence, boolean locking, boolean stackless) {
    ...
    public void testEventSubprocessSignalWithStateNode() throws Exception {
        ...
        ksession = createKnowledgeSession(kbase);
        TestBpmn2ProcessEventListener procEventListener = new TestBpmn2ProcessEventListener();
