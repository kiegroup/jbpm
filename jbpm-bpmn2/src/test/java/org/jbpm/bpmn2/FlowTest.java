...
public class FlowTest extends JbpmBpmn2TestCase {
    ...
    public FlowTest(boolean persistence, boolean locking, boolean queueBased, String name) {
    ...
    public void testInclusiveSplitAndJoinWithTimer() throws Exception {
        ...
        if( queueBasedExecution ) {
            // because queueBased is faster than the old recursive model..
            Thread.sleep(100);
        }
    ...
    @Test
    public void queueBasedPersistence() throws Exception {
        ...
        assertTrue("Process instance should be queueBased", ((RuleFlowProcessInstance) processInstance).isQueueBased());

        ksession = restoreSession(ksession, true);
        processInstance = ksession.getProcessInstance(processInstance.getId());
        assertTrue("Restored process instance should be queueBased", ((RuleFlowProcessInstance) processInstance).isQueueBased());
    }
