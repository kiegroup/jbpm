...
create table AuditTaskImpl (id int8 not null, activationTime timestamp, actualOwner varchar(255), createdBy varchar(255), createdOn timestamp, deploymentId varchar(255), description varchar(255), dueDate timestamp, end_date timestamp, lastModificationDate timestamp, name varchar(255), parentId int8 not null, priority int4 not null, processId varchar(255), processInstanceId int8 not null, processSessionId int8 not null, status varchar(255), taskId int8, workItemId int8, primary key (id));
create table BAMTaskSummary (pk int8 not null, createdDate timestamp, duration int8, end_date timestamp, endDate timestamp, processInstanceId int8 not null, startDate timestamp, status varchar(255), taskId int8 not null, taskName varchar(255), userId varchar(255), OPTLOCK int4, primary key (pk));
...
create table TaskEvent (id int8 not null, correlationKey varchar(255), end_date timestamp, logTime timestamp, message varchar(255), processInstanceId int8, processType int4, taskId int8, type varchar(255), userId varchar(255), OPTLOCK int4, workItemId int8, primary key (id));
...
create table VariableInstanceLog (id int8 not null, log_date timestamp, end_date timestamp, externalId varchar(255), oldValue varchar(255), processId varchar(255), processInstanceId int8 not null, value varchar(255), variableId varchar(255), variableInstanceId varchar(255), primary key (id));
