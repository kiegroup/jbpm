...
create table TimerMappingInfo (id int8 not null, externalTimerId varchar(255), kieSessionId int8 not null, timerId int8 not null, uuid varchar(255) not null, info bytea, primary key (id));
