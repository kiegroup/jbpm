...
create table TaskEvent (id bigint not null, correlationKey varchar(255), logTime datetime2, message varchar(255), processInstanceId bigint, processType int, taskId bigint, type varchar(255), userId varchar(255), OPTLOCK int, workItemId bigint, primary key (id));
...
create table TimerMappingInfo (id bigint not null, externalTimerId varchar(255), kieSessionId bigint not null, timerId bigint not null, uuid varchar(255) not null, primary key (id));
