...
create table TaskEvent (id number(19,0) not null, logTime timestamp, message varchar2(255 char), processInstanceId number(19,0), taskId number(19,0), type varchar2(255 char), userId varchar2(255 char), OPTLOCK number(10,0), workItemId number(19,0), correlationKey varchar(255), processType number(1,0), primary key (id));
