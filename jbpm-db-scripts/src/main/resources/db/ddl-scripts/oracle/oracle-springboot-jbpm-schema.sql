...
create table TaskEvent (id number(19,0) not null, correlationKey varchar2(255 char), logTime timestamp, message varchar2(255 char), processInstanceId number(19,0), processType number(10,0), taskId number(19,0), type varchar2(255 char), userId varchar2(255 char), OPTLOCK number(10,0), workItemId number(19,0), primary key (id));
