...
mvn archetype:generate 
   ...
   -DarchetypeVersion=7.39.0.Final
   -Dversion=7.39.0.Final
...
```
mvn archetype:generate -DarchetypeGroupId=org.jbpm -DarchetypeArtifactId=jbpm-workitems-archetype -DarchetypeVersion=7.39.0.Final -Dversion=7.39.0.Final -DgroupId=org.jbpm.contrib -DartifactId=myworkitem -DclassPrefix=MyWorkItem -DarchetypeCatalog=local
```
