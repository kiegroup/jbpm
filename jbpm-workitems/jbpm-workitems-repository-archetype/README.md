...
mvn archetype:generate 
   ...
   -DarchetypeVersion=7.50.0-SNAPSHOT
   -Dversion=7.50.0-SNAPSHOT
...
```
mvn archetype:generate -DarchetypeGroupId=org.jbpm -DarchetypeArtifactId=jbpm-workitems-repository-archetype -DarchetypeVersion=7.50.0-SNAPSHOT -Dversion=7.50.0-SNAPSHOT -DgroupId=org.jbpm.contrib -DartifactId=myworkitem -DclassPrefix=MyWorkItem -DarchetypeCatalog=local
```
