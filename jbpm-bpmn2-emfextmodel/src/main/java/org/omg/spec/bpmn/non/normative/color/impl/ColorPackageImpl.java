...
public class ColorPackageImpl extends EPackageImpl implements ColorPackage {
     ...
     * @generated
     */
    private EDataType hexColorEDataType = null;
     ...
     * @see org.omg.spec.bpmn.non.normative.color.ColorPackage#eNS_URI
     * @see #init()
     * @generated
     */
    ...
    public void createPackageContents() {
        ...
        createEAttribute(documentRootEClass, DOCUMENT_ROOT__BORDER_COLOR);
        createEAttribute(documentRootEClass, DOCUMENT_ROOT__COLOR);

        // Create data types
        hexColorEDataType = createEDataType(HEX_COLOR);
    }
