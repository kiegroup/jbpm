 ...
 * <!-- end-user-doc -->
 * @see org.omg.spec.bpmn.non.normative.color.ColorPackage
 * @generated
 */
public class ColorValidator extends EObjectValidator {
    /**
     ...
     * @generated
     */
    public static final String DIAGNOSTIC_SOURCE = "org.omg.spec.bpmn.non.normative.color";
    ...
    protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
        switch (classifierID) {
            case ColorPackage.DOCUMENT_ROOT:
                return validateDocumentRoot((DocumentRoot)value, diagnostics, context);
            case ColorPackage.HEX_COLOR:
                return validateHexColor((String)value, diagnostics, context);
            default:
                return true;
        }
    }
     ...
     * <!-- end-user-doc -->
     * @generated
     * @see #validateHexColor_Pattern
     */
    public static final  PatternMatcher [][] HEX_COLOR__PATTERN__VALUES =
        new PatternMatcher [][] {
            new PatternMatcher [] {
